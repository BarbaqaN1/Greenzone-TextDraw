...
PublicTD[1] = TextDrawCreate(9.000000, 215.000000, "ld_beat:chit");
TextDrawFont(PublicTD[1], 4);
TextDrawLetterSize(PublicTD[1], 0.600000, 2.000000);
TextDrawTextSize(PublicTD[1], 15.000000, 20.000000);
...
PublicTD[3] = TextDrawCreate(72.000000, 198.000000, "_");
TextDrawFont(PublicTD[3], 1);
TextDrawLetterSize(PublicTD[3], 0.600000, 2.449997);
TextDrawTextSize(PublicTD[3], 298.500000, 75.000000);
...
PublicTD[5] = TextDrawCreate(71.000000, 201.000000, "GREENZONE");
TextDrawFont(PublicTD[5], 1);
TextDrawLetterSize(PublicTD[5], 0.412499, 1.600000);
...
TextDrawColor(PublicTD[5], 16711935);
